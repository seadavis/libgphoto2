 ...
 * as static.
 */
int __declspec(dllexport) camera_id		(CameraText *id);
int __declspec(dllexport) camera_abilities 	(CameraAbilitiesList *list);
int __declspec(dllexport) camera_init 	(Camera *camera, GPContext *context);
